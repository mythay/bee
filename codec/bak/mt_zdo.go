...
type MatchDescReqFormat struct {
	...
	ProfileID         uint16
	NumInClusters     uint8
	InClusterList     [16]uint16
	NumOutClusters    uint8
	OutClusterList    [16]uint16
}
...
type MgmtNwkDiscRspFormat struct {
	...
	NetworkList      [72]NetworkListItemFormat
}
...
type MgmtLqiRspFormat struct {
	...
	NeighborLqiList      [66]NeighborLqiListItemFormat
}
...
type MgmtRtgRspFormat struct {
	...
	RoutingTableList      [75]RoutingTableListItemFormat
}
...
type MgmtBindRspFormat struct {
	...
	StartIndex            uint8
	BindingTableListCount uint8
	BindingTableList      [75]BindingTableListItemFormat
}
...
type BeaconNotifyIndFormat struct {
	BeaconCount uint8
	BeaconList  [21]BeaconListItemFormat
}
